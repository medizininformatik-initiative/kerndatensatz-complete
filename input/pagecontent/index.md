...
>
> **MolGen ist final** — deklariert allerdings weiterhin die RC-Fassungen von Base, Biobank und Meta, obwohl von allen dreien die finale Version vorliegt.
>
...
| Molekulargenetik | `de.medizininformatikinitiative.kerndatensatz.molgen` | 2027.0.0-ballot | [kerndatensatzmodul-GenetischeTests](https://github.com/medizininformatik-initiative/kerndatensatzmodul-GenetischeTests) | nur als Package publiziert |
...
```yaml
dependencies:
  de.medizininformatikinitiative.kerndatensatz.complete: 2027.0.0-ballot.8
```
...
Solange das Paket noch nicht auf packages.fhir.org verfügbar ist, kann es vom [GitHub Release](https://github.com/medizininformatik-initiative/kerndatensatz-complete/releases/tag/v2027.0.0-ballot.8) heruntergeladen und lokal installiert werden:

```bash
# Package herunterladen
curl -LO https://github.com/medizininformatik-initiative/kerndatensatz-complete/releases/download/v2027.0.0-ballot.8/de.medizininformatikinitiative.kerndatensatz.complete-2027.0.0-ballot.8.tgz

# In den lokalen FHIR-Cache installieren
fhir install de.medizininformatikinitiative.kerndatensatz.complete-2027.0.0-ballot.8.tgz
```
